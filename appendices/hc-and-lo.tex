...
I have invested substantial effort into basing all of the analysis in this paper on high-quality, typically peer-reviewed work. The introduction in Chapter \ref{chap:intro} connects the work in this paper to the broader set of related literature by citing numerous review papers and extracting/synthesizing key connections to the current work. Chapter \ref{chap:framework} establishes the key theoretical foundation of this work by connecting and reviewing the two leading frameworks for causal inference - Rubin's Potential Outcomes and Pearl's Structural Causal Models. Chapter \ref{chap:litreview}, as discussed above, provides a close review of wide (but not exhaustive) set of the causal inference benchmarking literature.\par

Finally, it is worth noting that the sources which appear in the work represent only about a third of the sources which I reviewed during the past year of work. This means, beyond being high-quality, peer-reviewed works, they represent a strict filtering for work that is most relevant to supporting my analysis. This is relative quality.
...
used in Chapter \ref{chap:macvalidation}.
...
\subsection{\textbf{\#biasidentification}}
\label{hc:biasidentification}

used in the review of existing methods when discussing how researchers may introduce bias by selecting functions which suit their own methods.
...
Applied to estimating the relative advantage of compilation vs dynamic execution using the Big-O complexity approximation. Documented in Chapter \ref{chap:macimplementation}.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\subsection{\textbf{\#biasmitigation}}
...
\subsection{\textbf{\#communicationdesign}}
...
\subsection{\textbf{\#confidenceintervals}}
