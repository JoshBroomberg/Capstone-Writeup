...
\end{tabular}
\caption{Concretization of the generic DGP under the design of \cite{Huber2013TheScore}}
...
\end{tabular}
\caption{Concretization of the generic DGP under the design of \cite{Dorie2019Automated1}}
...
\vspace{\baselineskip}
Based on the properties above, it appears that the design proposed by \cite{Dorie2019Automated1} has all of the desired validity properties - although the degree of validity may be contingent on design details like the size of the function space. Table \ref{tbl:comparison-pure-vs-hybrid-prop} compares the validity properties of the three methods based on experimental data and principled function construction.
