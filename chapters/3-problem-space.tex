...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/ch3-nonlinearity.png}
    \label{fig:toy-1}
\end{figure}
\FloatBarrier
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/ch3-noise.png}
    \label{fig:toy-2}
\end{figure}
\FloatBarrier
...
\vspace{\baselineskip}
\textbf{TODO NOTE: I haven’t yet constructed this example. As it doesn’t conform to the standard template of the other examples.}\par
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/ch3-balance.png}
    \label{fig:toy-3}
\end{figure}
\FloatBarrier
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/ch3-percent-treated.png}
    \label{fig:toy-4}
\end{figure}
\FloatBarrier
\par
...
\vspace{\baselineskip}
	\item \textbf{The Degree of Alignment Between the Treatment Assignment and Response Mechanism:} the number of confounding covariates - that appear in both the treatment assignment and outcome mechanisms - relative to the number of non-confounding, but still, predictive covariates - that appear in at least of the two mechanisms. The term alignment, to reflect this degree of confounding, is taken from \cite{Kern2016AssessingPopulations}.
